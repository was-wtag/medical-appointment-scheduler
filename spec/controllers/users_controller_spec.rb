RSpec.describe UsersController, type: :controller do
  ...
  context 'GET #show' do
    it 'should assign the requested user as @user' do
      get :show, params: { id: female_user.id }
      expect(assigns(:user)).to eq(female_user)
    end
  ...
  context 'GET #edit' do
    it 'should assign the requested user as @user' do
      get :edit, params: { id: female_user.id }
      expect(assigns(:user)).to eq(female_user)
    end
  ...
  context 'POST #create with valid params' do
    it 'should assign a newly created user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user) }
  ...
  context 'POST #create with invalid params because of missing names' do
    it 'should assign a newly created but unsaved user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user, :missing_first_name) }
      expect(assigns(:user)).to be_a_new(User)
    end
  ...
  context 'POST #create with invalid params because of missing contact information' do
    it 'should assign a newly created but unsaved user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user, :missing_email) }
      expect(assigns(:user)).to be_a_new(User)
    end
  ...
  context 'POST #create with invalid params because of missing password information' do
    it 'should assign a newly created but unsaved user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user, :missing_password) }
      expect(assigns(:user)).to be_a_new(User)
    end
  ...
  context 'POST #create with invalid params because of invalid format' do
    it 'should assign a newly created but unsaved user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user, :invalid_email) }
      expect(assigns(:user)).to be_a_new(User)
    end
  ...
  context 'POST #create with invalid params because of duplicate email' do
    it 'should assign a newly created but unsaved user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user, :duplicate_email) }
      expect(assigns(:user)).to be_a(User)
    end
  ...
  context 'POST #create with invalid params because of duplicate phone number' do
    it 'should assign a newly created but unsaved user as @user' do
      post :create, params: { user: FactoryBot.attributes_for(:male_user, :duplicate_phone_number) }
      expect(assigns(:user)).to be_a_new(User)
    end
  ...
  context 'PATCH #update with valid params' do
    it 'should assign the requested user as @user' do
      patch :update,
            params: { id: female_user.id, user: FactoryBot.attributes_for(:female_user, :update_first_name) }
      expect(assigns(:user)).to eq(female_user)
    end
    ...
    it 'should update the requested user' do
      patch :update,
            params: { id: female_user.id, user: FactoryBot.attributes_for(:female_user, :update_first_name) }
      expect(female_user.reload.first_name).to eq(female_user.first_name)
    end

    it 'should redirect to the user' do
      patch :update,
            params: { id: female_user.id, user: FactoryBot.attributes_for(:female_user, :update_first_name) }
      expect(response).to redirect_to(female_user)
    end
  end
  ...
  context 'PATCH #update with invalid params' do
    it 'should assign the user as @user' do
      patch :update,
            params: { id: female_user.id, user: FactoryBot.attributes_for(:female_user, :missing_first_name) }
      expect(assigns(:user)).to eq(female_user)
    end
    ...
    it 'should not update the user' do
      patch :update,
            params: { id: female_user.id, user: FactoryBot.attributes_for(:female_user, :missing_first_name) }
      expect(User.first.reload.first_name).not_to eq(FactoryBot.attributes_for(:female_user,
